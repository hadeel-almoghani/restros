...
final class Admin
{
    ...
    public static function AddAdminModel($table, $data): string
    {
    ...
    public static function EditAdminModel($table, $data): string
    {
    ...
    public static function DeleteAdminModel($table, $data): string
    {

        ...
        <div class="modal-content center">
            ...
            <form>
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <input id="password_reg" type="password" class="validate" autocomplete="new-password">
                ...
                <a href="javascript:void(0)" id="submit_reg" class="waves-effect waves-light btn">Register</a>

...
<section class="fcategories">
    ...
    <div class="container">
        ...
        <div class="section white center">
            <h3 class="header">Welcome <?= $_SESSION['user'] ?></h3>
        </div>

        <?php if (count($arr_all) == 0) {
            echo '<div class="section gray center" style="border: 1px solid black; border-radius: 5px;margin-bottom:30px">
			<p class="header">You don\'t purchase any order!</p>
		</div>';
        } else {  ?>
